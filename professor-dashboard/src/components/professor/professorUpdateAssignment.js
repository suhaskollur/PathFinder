...
//                         assignment_deadline: response.data.assignment_deadline.split('T')[0] // assuming date comes in ISO format
//                     });
//                 }
//                 setLoading(false);
//             } catch (err) {
...
//         e.preventDefault();
//         try {
//             await axios.put(`http://localhost:3000/api/professors/${courseId}/assignments/${assignmentId}`, inputs);
